...
public class Task implements Serializable {
	...
	@Column(name="Tasking_user_id")
	private int Tasking_user_id;
	...
	public final int getTasking_user_id() {
		return Tasking_user_id;
	}

	public final void setTasking_user_id(int Tasking_user_id) {
		this.Tasking_user_id = Tasking_user_id;
	}
