...
(function (factory) {
  ...
  $.extend(true,$.summernote.lang, {
    ...
    'ko-KR': { /* Korean */
        videoAttributes: {
          dialogTitle: 'Video Attributes 동영상 추가',
          tooltip: 'Video Attributes',
          pluginTitle: 'Video Attributes',
          href: '동영상 URL',
          videoSize: '비디오 사이즈',
          ...
          videoOption4: '560x315',
          alignment: '정렬',
          alignmentOption0: '정렬 없음',
          alignmentOption1: '왼쪽 정렬',
          alignmentOption2: '오른쪽 정렬',
          alignmentOption3: '기본',
          alignmentOption4: '문단 정렬에 맞춤',
          suggested: '비디오가 끝났을 때 추천 동영상 보여줌',
          controls: '플레이어 컨트롤러를 보여줌',
          autoplay: '자동 재생',
          loop: '반복 재생',
          note: '주의: 선택한 옵션이 모든 동영상에 적용되지 않을 수 있습니다.',
          ok: '동영상 추가'
        }
      }
  });
